...
const InventoryReport: React.FC = () => {
    ...
    const handleDownloadExcel = async () => {
        try {
            ...
            const response = await axiosInstance.get(`http://147.79.115.89:3000/api/inventory-valuation-summary-excel/${companyId}`, {
                responseType: 'blob',
            });
            ...
            link.href = url;
            link.setAttribute('download', 'inventory_valuation.xlsx');
