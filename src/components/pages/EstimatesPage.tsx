...
export default function EstimatesPage() {
  ...
  const fetchEstimates = async () => {
    try {
      ...
      const response = await axiosInstance.get(`https://powerkeybackend-production.up.railway.app/api/getEstimates/${selectedCompany?.company_id}`);
  ...
  const fetchEstimateItems = async (estimateId: number) => {
    try {
      const response = await axiosInstance.get(`https://powerkeybackend-production.up.railway.app/api/estimatesItems/${selectedCompany?.company_id}/${estimateId}`);
  ...
  const handleDelete = async (id: number) => {
    if (window.confirm('Are you sure you want to delete this estimate?')) {
      try {
        await axiosInstance.delete(`https://powerkeybackend-production.up.railway.app/api/deleteEstimate/${selectedCompany?.company_id}/${id}`);
        fetchEstimates();
      } catch (error: any) {
